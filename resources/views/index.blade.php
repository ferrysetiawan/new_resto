                ...
                <div class="col-md-6 p-rl-1 p-t-2">
                    <div class="row m-rl--1">
                        ...
                        <div class="col-12 p-rl-1 p-b-2">
                            <div class="bg-img1 size-a-4 how1 pos-relative" style="background-image: url({{ asset($item->thumbnail) }});background-size: cover; background-position: center;">
                                <a href="{{ route('news.show', $item->slug) }}" class="dis-block how1-child1 trans-03"></a>
                        ...
                        <div class="col-sm-6 p-rl-1 p-b-2">
                            <div class="bg-img1 size-a-5 how1 pos-relative" style="background-image: url({{ asset($item->thumbnail) }});background-size: cover; background-position: center;">
                                <a href="{{ route('news.show', $item->slug) }}" class="dis-block how1-child1 trans-03"></a>
